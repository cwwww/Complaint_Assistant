    ...
    >
      ...
      <div class="wrapper" ref="wrapper">
          ...
          <div class="bottom">
              ...
              <div class="btn" @click="submit"><span>发送</span></div>
          </div>
...
import { reqCusayrob, reqHistoryCustomer, reqCustomerInput} from '../../axios/axios-api'
  ...
  .wrapper{
    ...
    .bottom{
      .content-bottom{
        ...
        left: 0;
        input{
          width: 95%; margin-left: 15px; overflow: hidden; white-space: nowrap; text-overflow: ellipsis;
          font-size:16px;
