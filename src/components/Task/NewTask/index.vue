...
export default {
  ...
  data() {
    return {
      ...
      img_sec: require("../../../assets/images/hi@2x.png"),
      img_thir: require("../../../assets/images/baifang@2x.png"),
