<template>
  <div class="contain">
    ...
    >
      ...
      <div class="wrap" v-if="goodsList.length >0">
        <div class="left">
      ...
      <div class="bottomLine" v-if="goodsList.length >0"></div>
    </van-popup>
  </div>
</template>
<script>
