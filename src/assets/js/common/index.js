...
//  }
    ...
    function showResult(uaStr) {
        ...
        $("#ua_browser .ua_item_version").html(ua_browser_version.toLowerCase());
        var browser_icon = '';
...
//      $("#ua_os .ua_logo").html('<img src="'+BASE_URL+'/images/icons/os/'+os_icon+'" width=64 height=64 />');
        ...
        if(ua_device_type == 'desktop'){
            ...
            if(tmp_os_name == 'ios') {
               ...
               ua_device_model= ua_device_model.toLowerCase();
            } else {
        ...
        $("#ua_device .ua_item_version").html(ua_device_model.replace('-',' '));
