...
class Evaluator(Matcher):
    ...
    def getBestResponse(self, responses, topk, debugMode=False):
        ...
        # print('1.responses: ',responses)
        self.buildResponses(responses)
        # print('2.self.responses: ', self.responses)
        self.segmentResponse()
        # print('3.self.segResponses',self.segResponses)
    ...
    def buildResponses(self, responses):
        ...
        if len(self.responses)==0: self.responses.append(("这个我也不太明白呢"))
    ...
    def evaluateByGrade(self,topk,debug=True):
        """
        ...
        for i in range(0, len(self.segResponses)):
            ...
            if wordCount == 0 or sourceCount > 400:
                continue
            ...
            # print("error1:",self.segResponses[i])
            # print("error2 avgWords",avgWords)
            # print("error3 len:",len(self.segResponses[i]))
            # print("error4:",(math.log(len(self.segResponses[i])+1,avgWords) + 1))
